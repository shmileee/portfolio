...
| `period`         | string          | When the work happened: a year or an en-dash range (`2022–2024`, `2023–present`). Shown in the study's metadata line and in the homepage reader. Optional                                  |
| `sequel`         | slug            | The folder this study continues in. The engine renders a "Continues in" card at the end of this body and a "Continues from" card at the end of the other; declaring one side is enough, and an unknown folder fails the build. Optional |
| `prequel`        | slug            | The folder this study continues from; the reverse of `sequel`, for when the later study is the one being edited. Optional                                                                  |
