...
A cell is one Terraform stack that provisions everything — the VPC, the EKS cluster with its networking, IAM, DNS, and identity integration — and it joins the Cloud WAN network from [the network nobody dared touch](/case-studies/the-network-nobody-dared-touch/) with one flag. Three design pieces I'm particularly proud of:
