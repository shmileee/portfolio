...
description: A broken Terraform provider was forked and fixed in four days, and the internal registry built to serve it became the company’s one governed distribution point for every provider.
topics:
  - reliability
  - delivery
order: 18
