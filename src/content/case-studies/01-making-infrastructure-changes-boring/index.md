...
summary: Infrastructure went from tribal knowledge to a reviewable, reversible, self-documenting system.
topics:
  - delivery
...
When I joined, infrastructure changes were largely hand-applied: someone with the right access ran the right commands and everyone hoped for the best. Change history lived in people's memories, and reviewers couldn't see what a change would actually do to production.
...
3. Only then did I turn on auto-deployment. One month after the migration — once people could see diffs and trust the pipeline — merged changes began applying themselves. Nobody had to be brave anymore.
...
Infrastructure went from tribal knowledge to a reviewable, reversible, self-documenting system that any engineer can propose changes to safely. Everything else in this portfolio stands on this.
