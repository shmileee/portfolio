...
- Production pins exact image IDs — and the dependency bot ([case study 8](/#study-8)) proposes the bump as a pull request. The merge button *is* the deployment gate: human review, full audit trail, no custom tooling.
